...
VRC is a theme based on VRC, a stylized, re-colorable, multi-column theme which uses HTML5
...
VRC 7.x-1.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: VRC includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/vrc to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/vrc to modify the color scheme if desired.

* Menus: The vrc theme does not support the hard coded menu defaults. To setup
...
vrc supports the Superfish module which is a dynamic menu module and enables 
...
Please see the help page and the starter sub-theme documentation at:
