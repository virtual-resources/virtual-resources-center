...
function at_theme_settings_submit($form, &$form_state) {
  ...
  // RTL layout
  $rtl_layout_data = str_replace('left', 'a7r3u8', $layout_data);
  $rtl_layout_data = str_replace('right', 'left', $rtl_layout_data);
  $rtl_layout_data = str_replace('a7r3u8', 'right', $rtl_layout_data);

  $rtl_layout_file            = $theme . '.responsive.layout-rtl.css';
  $rtl_layout_filepath        = $path . '/' . $rtl_layout_file;
  file_save_data($rtl_layout_data, $rtl_layout_filepath, FILE_EXISTS_REPLACE);
...
function at_layout_styles($method, $sidebar_first, $sidebar_second, $sidebar_unit) {
  ...
  if ($method == 'three-col-grail') {
    ...
    $styles[] = '.region-sidebar-first {width: ' . $sidebar_first . '; margin-' . $left . ': -100%; margin-' . $right . ': 0;}';
    $styles[] = '.region-sidebar-second {width: ' . $sidebar_second . '; margin-' . $left . ': -' . $pull_right . '; margin-' . $right . ': 0; clear: none;}';
  }
  if ($method == 'three-col-right') {
    ...
    $styles[] = '.sidebar-second .content-inner {margin-' . $right . ': ' . $push_right . '; margin-' . $left . ': 0;}';
    $styles[] = '.region-sidebar-first {width: ' . $sidebar_first . $sidebar_unit . '; margin-' . $left . ': -' . $left_margin . '; margin-' . $right . ': 0;}';
    $styles[] = '.region-sidebar-second {width: ' . $sidebar_second . $sidebar_unit . '; margin-' . $left . ': -' . $right_margin . '; margin-' . $right . ': 0; clear: none;}';
    $styles[] = '.sidebar-first .region-sidebar-first {width: ' . $sidebar_first . $sidebar_unit . '; margin-' . $left . ': -' . $sidebar_first . $sidebar_unit . '; margin-' . $right . ': 0;}';
  }
  if ($method == 'three-col-left') {
    ...
    $styles[] = '.region-sidebar-first {width: ' . $sidebar_first . $sidebar_unit . '; margin-' . $left . ': -100%; margin-' . $right . ': 0;}';
    $styles[] = '.region-sidebar-second {width: ' . $sidebar_second . $sidebar_unit . '; margin-' . $left . ': -100%; margin-' . $right . ': 0; clear: none;}';
    $styles[] = '.two-sidebars .region-sidebar-second {width: ' . $sidebar_second . $sidebar_unit . '; position: relative; ' . $left . ': ' . $push_right . ' ; ' . $right . ': auto;}';
  }
  if ($method == 'two-col-stack') {
    ...
    $styles[] = '.region-sidebar-first {width: ' . $sidebar_first . $sidebar_unit . '; margin-' . $left . ': -' . $push_right . '; margin-' . $right . ': 0;}';
